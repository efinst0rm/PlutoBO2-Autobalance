...
changeTeam( team )
{
	...
	//if ( assignment != self.pers["team"] && (self.sessionstate == "playing" || self.sessionstate == "dead") ) // Should be this but compiler won't complie it
	if (assignment != self.pers["team"] && self.sessionstate == "dead")
	{
